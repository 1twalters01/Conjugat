...
for count in range(40):
    urls = get_urls('French', languages['French']-1, [[]]*len(languages), 900+math.floor(count*700/40), 900+math.floor((count+1)*700/40))
    ...
    urls = get_urls('French', languages['French']-1, [[]]*len(languages), 700+math.floor(count*900/40), 700+math.floor((count+1)*900/40))
    ...
    urls = get_urls('French', languages['French']-1, [[]]*len(languages), 600+math.floor(count*1000/40), 600+math.floor((count+1)*1000/40))
    ...
    urls = get_urls('French', languages['French']-1, [[]]*len(languages), 500+math.floor(count*600/40), 500+math.floor((count+1)*600/40))
    ...
    urls = get_urls('French', languages['French']-1, [[]]*len(languages), math.floor(count*1300/40), math.floor((count+1)*1300/40))
    sentences = get_sentences(languages['French']-1, sentences, urls, 'Subjonctif Plus-Que-Parfait', Tense_dict[3]['Subjonctif Plus-Que-Parfait']-1)

    urls = get_urls('French', languages['French']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    sentences = get_sentences(languages['French']-1, sentences, urls, 'Subjonctif Imparfait', Tense_dict[3]['Subjonctif Imparfait']-1)

    urls = get_urls('French', languages['French']-1, [[]]*len(languages), math.floor(count*900/40), math.floor((count+1)*900/40))
    sentences = get_sentences(languages['French']-1, sentences, urls, 'Indicatif Passé Anterieur', Tense_dict[3]['Indicatif Passé Anterieur']-1)

    urls = get_urls('French', languages['French']-1, [[]]*len(languages), math.floor(count*900/40), math.floor((count+1)*900/40))
    sentences = get_sentences(languages['French']-1, sentences, urls, 'Conditionnel Passé Deuxième Forme', Tense_dict[3]['Conditionnel Passé Deuxième Forme']-1)
