...
for count in range(30):
    urls = get_urls('Portuguese', languages['Portuguese']-1, [[]]*len(languages), 1600+math.floor(count*400/30), 1600+math.floor((count+1)*400/30))
    ...
    urls = get_urls('Portuguese', languages['Portuguese']-1, [[]]*len(languages), 1300+math.floor(count*700/30), 1300+math.floor((count+1)*700/30))
    ...
    urls = get_urls('Portuguese', languages['Portuguese']-1, [[]]*len(languages), 1100+math.floor(count*900/30), 1100+math.floor((count+1)*900/30))
