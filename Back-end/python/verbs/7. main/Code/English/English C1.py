...
for count in range(40):
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), 900+math.floor(count*700/40), 900+math.floor((count+1)*700/40))
    ...
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), 700+math.floor(count*900/40), 700+math.floor((count+1)*900/40))
    ...
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), 600+math.floor(count*1000/40), 600+math.floor((count+1)*1000/40))
    ...
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), math.floor(count*1300/40), math.floor((count+1)*1300/40))
    sentences = get_sentences(languages['English']-1, sentences, urls, 'Indicative Future Continuous', Tense_dict[4]['Indicative Future Continuous']-1)

    urls = get_urls('English', languages['English']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    sentences = get_sentences(languages['English']-1, sentences, urls, 'Perfect Participle', Tense_dict[4]['Perfect Participle']-1)
    
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    sentences = get_sentences(languages['English']-1, sentences, urls, 'Indicative Past Perfect Continuous', Tense_dict[4]['Indicative Past Perfect Continuous']-1)

    urls = get_urls('English', languages['English']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    sentences = get_sentences(languages['English']-1, sentences, urls, 'Indicative Future Perfect Continuous', Tense_dict[4]['Indicative Future Perfect Continuous']-1)
