...
for count in range(40):
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 900+math.floor(count*700/40), 900+math.floor((count+1)*700/40))
    ...
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 700+math.floor(count*900/40), 700+math.floor((count+1)*900/40))
    ...
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 600+math.floor(count*1000/40), 600+math.floor((count+1)*1000/40))
    sentences = get_sentences(languages['Italian']-1, sentences, urls, 'Condizionale Passato', Tense_dict[2]['Condizionale Passato']-1)

    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 600+math.floor(count*700/40), 600+math.floor((count+1)*700/40))
    ...
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), math.floor(count*1300/40), math.floor((count+1)*1300/40))
    ...
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    ...
    urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), math.floor(count*900/40), math.floor((count+1)*900/40))
...
sentences = [()]*len(languages)
try:
    myfile = 'python/verbs/7. main/tuples/'+'Italian'+' C1.pkl'
