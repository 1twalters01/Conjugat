...
urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 0, 35)
sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Indicativo Presente', Tense_dict[0]['Indicativo Presente']-1)

urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 0, 30)
sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Participio Pasado', Tense_dict[0]['Participio Pasado']-1)

urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 35, 80)
sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Indicativo Presente', Tense_dict[0]['Indicativo Presente']-1)

urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 30, 55)
sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Participio Pasado', Tense_dict[0]['Participio Pasado']-1)
