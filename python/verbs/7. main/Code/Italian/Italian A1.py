...
urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 0, 35)
sentences = get_sentences(languages['Italian']-1, sentences, urls, 'Indicativo Presente', Tense_dict[2]['Indicativo Presente']-1)

urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 0, 30)
...
urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 35, 80)
sentences = get_sentences(languages['Italian']-1, sentences, urls, 'Indicativo Presente', Tense_dict[2]['Indicativo Presente']-1)

urls = get_urls('Italian', languages['Italian']-1, [[]]*len(languages), 30, 55)
sentences = get_sentences(languages['Italian']-1, sentences, urls, 'Participio Passato', Tense_dict[2]['Participio Passato']-1)
