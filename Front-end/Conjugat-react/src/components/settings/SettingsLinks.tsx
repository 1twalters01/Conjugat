    ...
    return (
        <div className="settings-links">
            ...
            <div className="profile">
                <h4 className="profile-text header">Profile</h4>
            ...
            <div className="application">
                <h4 className="profile-text header">Application</h4>
            ...
            <div className="options">
                <h4 className="options-text header">Options</h4>
            ...
            <div className="account">
                <h4 className="account-text header">Account</h4>
