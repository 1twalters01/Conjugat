...
for count in range(40):
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), 1600+math.floor(count*400/30), 1600+math.floor((count+1)*400/30))
    ...
    urls = get_urls('English', languages['English']-1, [[]]*len(languages), 1300+math.floor(count*700/30), 1300+math.floor((count+1)*700/30))
