...
for count in range(0,40):
    ...
    print('Indicativo Pretérito perfecto simple', count)
    ...
    print('Subjuntivo Pretérito imperfecto', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 900+math.floor(count*700/40), 900+math.floor((count+1)*700/40))
    sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Indicativo Condicional', Tense_dict[0]['Indicativo Condicional']-1)
    print('Indicativo Condicional', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 600+math.floor(count*1000/40), 900+math.floor((count+1)*1000/40))
    ...
    print('Subjuntivo Pretérito imperfecto (2)', count)
    ...
    print('Indicativo Pretérito pluscuamperfecto', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 600+math.floor(count*1000/40), 600+math.floor((count+1)*1000/40))
    ...
    print('Subjuntivo Pretérito pluscuamperfecto', count)
    ...
    print('Subjuntivo Pretérito pluscuamperfecto (2)', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 900+math.floor(count*700/40), 900+math.floor((count+1)*700/40))
    sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Infinitivo compuesto', Tense_dict[0]['Infinitivo compuesto']-1)
    print('Infinitivo compuesto', count)
    
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), math.floor(count*1300/40), math.floor((count+1)*1300/40))
    ...
    print('Subjuntivo Pretérito perfecto', count)
    ...
    print('Indicativo Futuro perfecto', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), math.floor(count*1100/40), math.floor((count+1)*1100/40))
    sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Subjuntivo Futuro', Tense_dict[0]['Subjuntivo Futuro']-1)
    print('Subjuntivo Futuro', count)
    ...
    print('Indicativo Condicional perfecto', count)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), math.floor(count*900/40), math.floor((count+1)*900/40))
    ...
    print('Indicativo Pretérito anterior', count)
    ...
    print('Subjuntivo Futuro perfecto', count)

    with open('python/verbs/7. main/tuples/'+'Spanish'+' C1.pkl', 'wb') as f:
...
for index, item in enumerate(languages):
    if sentences[index]:
        with open('python/verbs/7. main/tuples/'+item+' C1.pkl', 'wb') as f:
...
for index, item in enumerate(languages):
    try:
        myfile = 'python/verbs/7. main/tuples/'+item+' C1.pkl'
...
for index, item in enumerate(languages):
    if sentences[index]:
        f = open('python/verbs/7. main/json/'+item+' C1.json', 'w+', encoding="utf-8")
        f.write(json[index])
        f.close()