export const translations = {
    'English': {
        ...
        'metaContent2': 'Successfully logged out of Conjugat',
    ...
    'French': {
        ...
        'metaContent2': 'Déconnexion réussie de Conjugat',
    ...
    'Italian': {
        ...
        'metaContent2': 'Sei uscito da Conjugat con successo',
    ...
    'Portuguese': {
        ...
        'metaContent2': 'Saiu com sucesso do Conjugat',
    ...
    'Spanish': {
        ...
        'metaContent2': 'Se ha cerrado la sesión de Conjugat',
        'Text': '¿Estás seguro de que quieres cerrar la sesión?',
    },
}

export const LogoutBtnTranslations = {
    'English': {
        'Text': 'Log out',
    },
    'French': {
...
export const LogoutResponseTranslations = {
    'English': {
        'Text1': 'You have been successfully logged out.',
        'Text2': 'Home'
    },
    'French': {
        'Text1': 'Vous avez été déconnecté avec succès.',
        'Text2': 'Accueil'
    },
    'Italian': {
        'Text1': 'Il logout è stato effettuato con successo.',
        'Text2': 'Casa'
    },
    'Portuguese': {
        'Text1': 'A sua sessão foi terminada com sucesso.',
        'Text2': 'Início'
    },
    'Spanish': {
        'Text1': 'Se ha cerrado la sesión correctamente.',
        'Text2': 'Inicio'
    },
}