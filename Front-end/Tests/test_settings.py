...
class TestAccountApi(unittest.TestCase):
    ...
    #     self.assertEqual(HTTP_methods.post(urls['changePasswordView'], headers={'Authorization':'Token 01d40d2d327d682d8cbf73772d5078486f91874c'}).json()['error'], 'No email provided')
    #     self.assertEqual(HTTP_methods.post(urls['changePasswordView'], headers={'Authorization':'Token 01d40d2d327d682d8cbf73772d5078486f91874c'}, data={'email':'twalters1234579@gmail.com'}).json()['error'], 'No password provided')
    #     self.assertEqual(HTTP_methods.post(urls['changePasswordView'], headers={'Authorization':'Token 01d40d2d327d682d8cbf73772d5078486f91874c'}, data={'email':'twalters1234579@gmail.com', 'password':'aaa'}).json()['error'], 'Incorrect password')
    #     self.assertEqual(HTTP_methods.post(urls['changePasswordView'], headers={'Authorization':'Token 01d40d2d327d682d8cbf73772d5078486f91874c'}, data={'email':'conjugat465@gmail.com', 'password':'adf fdadf fd'}).json()['error'], 'Email is already in use')
    #     self.assertEqual(HTTP_methods.post(urls['changePasswordView'], headers={'Authorization':'Token 01d40d2d327d682d8cbf73772d5078486f91874c'}, data={'email':'1twalters01@gmail.com', 'password':'adf fdadf fd'}).json()['success'], 'Email changed successfully')
    #     # Disallowed methods
