...
for count in range(25):
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 450+math.floor(count*450/25), 450+math.floor((count+1)*450/25))
    ...
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 300+math.floor(count*400/25), 300+math.floor((count+1)*400/25))
    ...
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 350+math.floor(count*550/25), 350+math.floor((count+1)*550/25))
    sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Indicativo Condicional', Tense_dict[0]['Indicativo Condicional']-1)

    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), math.floor(count*600/25), math.floor((count+1)*600/25))
    ...
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), math.floor(count*900/25), math.floor((count+1)*900/25))
    sentences = get_sentences(languages['Spanish']-1, sentences, urls, 'Infinitivo compuesto', Tense_dict[0]['Infinitivo compuesto']-1)
    
    urls = get_urls('Spanish', languages['Spanish']-1, [[]]*len(languages), 300+math.floor(count*600/25), 300+math.floor((count+1)*600/25))
